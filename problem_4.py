...
def _flash_attention_forward_causal_kernel(
    ...
    # Define negative infinity for masking
    NEG_INF = -float('inf')
    ...
    for start_n in range(0, q_block_idx * BLOCK_M, BLOCK_N):
        ...
        # 2. Compute attention scores S_ij
        ...
        # 3. Online softmax update (m_i, l_i, acc)
